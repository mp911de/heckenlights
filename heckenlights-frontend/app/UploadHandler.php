...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null, $callback) {
        $this->response = array();
        $this->options = array(
    ...
    protected function initialize($callback) {
        switch ($this->get_server_var('REQUEST_METHOD')) {
            case 'PATCH':
            case 'PUT':
            case 'POST':
                $this->post($this->options['print_response'], $callback);
                break;
            default:
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            if ($uploaded_file && is_uploaded_file($uploaded_file)) {
                ...
                $fsize = filesize($uploaded_file);
                $file->contents = fread($handle, $fsize);
                fclose($handle);
    ...
    public function generate_response($content, $print_response = true, $encode = true) {
    ...
    public function post($print_response = true, $callback) {
        ...
        return $this->generate_response($result->response, $print_response, $result->encode);
    }
